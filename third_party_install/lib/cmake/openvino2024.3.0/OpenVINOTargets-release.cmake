...
set_target_properties(openvino::frontend::onnx PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenvino_onnx_frontend.so.2024.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino_onnx_frontend.so.2430"
  )

list(APPEND _cmake_import_check_targets openvino::frontend::onnx )
list(APPEND _cmake_import_check_files_for_openvino::frontend::onnx "${_IMPORT_PREFIX}/lib/libopenvino_onnx_frontend.so.2024.3.0" )
...
set_target_properties(openvino::frontend::pytorch PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenvino_pytorch_frontend.so.2024.3.0"
...
list(APPEND _cmake_import_check_files_for_openvino::frontend::pytorch "${_IMPORT_PREFIX}/lib/libopenvino_pytorch_frontend.so.2024.3.0" )
...
set_target_properties(openvino::frontend::tensorflow PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenvino_tensorflow_frontend.so.2024.3.0"
...
list(APPEND _cmake_import_check_files_for_openvino::frontend::tensorflow "${_IMPORT_PREFIX}/lib/libopenvino_tensorflow_frontend.so.2024.3.0" )
...
set_target_properties(openvino::frontend::tensorflow_lite PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenvino_tensorflow_lite_frontend.so.2024.3.0"
...
list(APPEND _cmake_import_check_files_for_openvino::frontend::tensorflow_lite "${_IMPORT_PREFIX}/lib/libopenvino_tensorflow_lite_frontend.so.2024.3.0" )
...
set_target_properties(openvino::frontend::paddle PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenvino_paddle_frontend.so.2024.3.0"
...
list(APPEND _cmake_import_check_files_for_openvino::frontend::paddle "${_IMPORT_PREFIX}/lib/libopenvino_paddle_frontend.so.2024.3.0" )
...
set_target_properties(openvino::runtime PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenvino.so.2024.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino.so.2430"
  )

list(APPEND _cmake_import_check_targets openvino::runtime )
list(APPEND _cmake_import_check_files_for_openvino::runtime "${_IMPORT_PREFIX}/lib/libopenvino.so.2024.3.0" )
...
set_target_properties(openvino::runtime::c PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenvino_c.so.2024.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino_c.so.2430"
  )

list(APPEND _cmake_import_check_targets openvino::runtime::c )
list(APPEND _cmake_import_check_files_for_openvino::runtime::c "${_IMPORT_PREFIX}/lib/libopenvino_c.so.2024.3.0" )
